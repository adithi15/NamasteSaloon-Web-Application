...
// import { BUSINESS_DETAILS, FAQS } from "../data.js";
...
//           {/* Quick Inquiry Message (Right Side) */}
//           <div className="lg:col-span-5 text-left">
//             <div className="bg-[#022A24] text-white p-6 md:p-8 rounded-3xl space-y-6 shadow-xl border border-[#2D5446]/20">
...
//                   Have a question about a treatment, membership plan, or booking? Type a quick note below to start a thread on WhatsApp with our front desk.
//                 </p>
//               </div>

//               <form onSubmit={handleInquirySubmit} className="space-y-4 text-white">
//                 <div className="space-y-1.5">
//                   <label className="text-[9px] font-mono tracking-widest text-[#DECBA5] font-black uppercase block">
//                     Your Name
//                   </label>
//                   <input
//                     type="text"
...
//                     className="w-full h-11 px-3 bg-[#011B17] text-white placeholder-white/20 border border-[#2D5446]/30 rounded-xl text-xs focus:outline-none focus:border-[#DECBA5] focus:bg-[#011B17]"
//                   />
//                 </div>
...
//                   </label>
//                   <textarea
//                     placeholder="Type your question or customized request here..."
//                     required
//                     value={messageText}
//                     onChange={(e) => setMessageText(e.target.value)}
//                     className="w-full h-28 p-3 bg-[#011B17] text-white placeholder-white/20 border border-[#2D5446]/30 rounded-xl text-xs focus:outline-none focus:border-[#DECBA5] focus:bg-[#011B17] resize-none"
//                   />
//                 </div>

//                 <button
//                   type="submit"
//                   className="w-full h-11 bg-[#DECBA5] hover:bg-[#FAF8F5] text-neutral-950 text-xs uppercase tracking-widest font-extrabold transition-all hover:scale-[1.02] shadow-md flex items-center justify-center gap-2 cursor-pointer rounded-xl"
//                 >
