...
//   const navMenuItems = {
//     locions: ["Boston", "Flatiron", "Soho", "West Hollywood"],
...
//               onClick={onOpenBooking}
//               onMouseEnter={() => setHoveredDropdown(null)}
//               className="font-bold tracking-widest transition-colors duration-300 py-8 relative cursor-pointer hover:text-white text-[#FAF8F5]/80"
//             >
//               Reservations
//             </motion.button>
//           </nav>
...
//                 </button>
//                 <button onClick={() => { onOpenBooking(); setMobileMenuOpen(false); }} className="w-full text-left py-2 font-bold flex items-center justify-between hover:text-[#A1CBB4] text-white/90 transition-colors duration-300">
//                   <span>Reservations</span><Calendar className="w-4 h-4 text-white" />
//                 </button>
//               </div>
//               <div className="flex flex-col gap-1.5 pb-4 border-b border-[#2D5446]/20">
//                 <span className="text-[9px] font-extrabold text-[#A1CBB4] tracking-[0.2em] flex items-center gap-1">
...
export default function Header({ onNavigate, onOpenBooking, activeView }) {
  ...
  // YOUR ORIGINAL LOGIC - Kept completely intact
  const dropItems = [
    { key: "locations", label: "Locations", delay: 0.15 },
    { key: "offerings", label: "Services", delay: 0.22 }, // Updated label to 'Services' while keeping logic
    // { key: "memberships", label: "Memberships", delay: 0.29 },
  ];
  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-15 h-20 md:h-24 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8 text-[11px] font-display tracking-widest uppercase text-[#FAF8F5]/90">
            ...
            <motion.button
              ...
              onClick={() => { onNavigate("home"); setHoveredDropdown(null); }}
              onMouseEnter={() => setHoveredDropdown(null)}
              className="hover:text-white transition-colors duration-300 focus:outline-none font-bold cursor-pointer text-[#FAF8F5]/90 py-8"
            >
              Home
            ...
            {/* YOUR ORIGINAL DROPDOWN LOOP LOGIC - Restored perfectly */}
            {dropItems.map(({ key, label, delay }) => (
              <motion.div
                key={key}
                initial={{ opacity: 0, y: 12 }}
            ...
            <motion.button
              initial={{ opacity: 0, y: 12 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.75, ease: [0.25, 0.46, 0.45, 0.94], delay: 0.33 }}
              onClick={() => { onNavigate("blog"); setHoveredDropdown(null); }}
              onMouseEnter={() => setHoveredDropdown(null)}
              className="hover:text-white transition-colors duration-300 focus:outline-none font-bold cursor-pointer text-[#FAF8F5]/90 py-8"
            >
              Blog
            ...
            <motion.button
              initial={{ opacity: 0, y: 12 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.75, ease: [0.25, 0.46, 0.45, 0.94], delay: 0.38 }}
              onClick={() => { onNavigate("contact"); setHoveredDropdown(null); }}
              onMouseEnter={() => setHoveredDropdown(null)}
              className="hover:text-white transition-colors duration-300 focus:outline-none font-bold cursor-pointer text-[#FAF8F5]/90 py-8"
            >
              Contact
            ...
            <motion.button
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.75, ease: [0.25, 0.46, 0.45, 0.94], delay: 0.43 }}
              onClick={() => { onNavigate("why-spa"); setHoveredDropdown(null); }}
              onMouseEnter={() => setHoveredDropdown(null)}
              className="font-bold tracking-widest transition-colors duration-300 py-8 relative cursor-pointer hover:text-white text-[#FAF8F5]/80"
            >
              Why Spa
      ...
      {/* ── DROPDOWN PANELS — Restored exactly as originally configured ── */}
            ...
            >
              <div className="grid grid-cols-5 gap-8">
                <div className="flex flex-col gap-3">
                  ...
                  {[
                    { name: "CHARNI ROAD", desc: "Somatic rest, contrast suites & multi-club passes." },
                    { name: "MUMBAI CENTRAL", desc: "Chroma thermal sauna & luxury hyperbaric admissions." },
                    { name: "VASHI", desc: "Dynamic pulse compression & bio-resonance packages." },
                    { name: "ANDHERI", desc: "Bespoke warm oil holistic massage & alchemical classes." },
                  ].map(({ name, desc }) => (
                    <div key={name} className="group/item cursor-pointer" onClick={() => scrollTo("services-carousel")}>
                      <span className="text-[11px] font-bold tracking-wider group-hover/item:text-[#A1CBB4] text-[#FAF8F5]/90 transition-colors duration-300 uppercase block">{name}</span>
                      <p className="text-[9px] text-[#FAF8F5]/50 font-medium leading-relaxed font-sans normal-case tracking-normal mt-0.5">{desc}</p>
          ...
          >
            <div className="p-6 flex flex-col gap-5 text-sm uppercase tracking-widest font-display text-white/90">
              <div className="flex flex-col gap-2 pb-4 border-b border-[#2D5446]/20">
                <span className="text-[9px] font-extrabold text-[#A1CBB4] tracking-[0.2em]">Quick Paths</span>
                <button onClick={() => { onNavigate("home"); setMobileMenuOpen(false); }} className="w-full text-left py-2 font-bold flex items-center justify-between text-white hover:text-[#A1CBB4] transition-colors duration-300">
                  <span>Home</span><Sparkles className="w-4 h-4 text-[#A1CBB4]" />
                </button>
                <button onClick={() => { onNavigate("services"); setMobileMenuOpen(false); }} className="w-full text-left py-2 font-bold flex items-center justify-between text-white hover:text-[#A1CBB4] transition-colors duration-300">
                  <span>Services</span><Layers className="w-4 h-4 text-[#A1CBB4]" />
                </button>
                <button onClick={() => { onNavigate("blog"); setMobileMenuOpen(false); }} className="w-full text-left py-2 font-bold flex items-center justify-between text-white hover:text-[#A1CBB4] transition-colors duration-300">
                  <span>Blog</span><Sparkles className="w-4 h-4 text-[#A1CBB4]" />
                </button>
                <button onClick={() => { onNavigate("contact"); setMobileMenuOpen(false); }} className="w-full text-left py-2 font-bold flex items-center justify-between text-white hover:text-[#A1CBB4] transition-colors duration-300">
                  <span>Contact</span><Sparkles className="w-4 h-4 text-[#A1CBB4]" />
                </button>
                <button onClick={() => { onNavigate("why-spa"); setMobileMenuOpen(false); }} className="w-full text-left py-2 font-bold flex items-center justify-between text-white hover:text-[#A1CBB4] transition-colors duration-300">
                  <span>Why Spa</span><Sparkles className="w-4 h-4 text-[#A1CBB4]" />
                </button>
              </div>
              <div className="flex flex-col gap-1.5 pb-4 border-b border-[#2D5446]/20">
                <span className="text-[9px] font-extrabold text-[#A1CBB4] tracking-[0.2em] flex items-center gap-1">
