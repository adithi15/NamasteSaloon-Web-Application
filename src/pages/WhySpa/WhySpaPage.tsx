...
export default function WhySpaPage({ onSelectSpecialist }: WhySpaPageProps) {
  return (
    ...
    >
      <div className="bg-[#022A24] text-[#FAF8F5] py-12 sm:py-16 text-center border-b border-[#2D5446]/20">
        <div className="max-w-3xl mx-auto px-4 space-y-3 sm:space-y-4">
          ...
          <h1 className="font-serif text-2xl sm:text-3xl md:text-5xl font-bold tracking-wider uppercase leading-tight">
